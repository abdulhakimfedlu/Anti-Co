...
export const translations = {
  en: {
    ...
    form: {
      ...
      // New Fields
      woreda: "Woreda",
      woredaPlaceholder: "e.g. 05",
      subcity: "Subcity",
      subcityPlaceholder: "e.g. Yeka",
      houseNumber: "House Number",
      houseNumberPlaceholder: "e.g. 1024 or New",
      specificPlace: "Specific Place",
      specificPlacePlaceholder: "e.g. Near Woreda Office",
      gender: "Sex / Gender",
      ...
      educationUneducated: "Uneducated",
      educationGrade4: "Up to Grade 4",
      educationGrade8: "Up to Grade 8",
      educationGrade10: "Up to Grade 10",
      educationGrade12: "Up to Grade 12 (Diploma)",
      educationDegree: "Holds Degree and Above",
      educationPreferNotToSay: "Prefer Not to Say",
      incidentLocation: "Where did this injustice/disappointment occur? (Subcity / Woreda)",
      incidentLocationPlaceholder: "e.g. Yeka Subcity, Woreda 05",
      suspectName: "Name of suspected/reported person",
      suspectNamePlaceholder: "e.g. Name of officer or official",
      // Success
  ...
  am: {
    ...
    hero: {
      ...
      subtext:
        "ለመርዳት እዚህ ነን። ማንነትዎ በተጠበቀ ሁኔታ ጥቆማዎን ያቅርቡ። የእኛ ቁርጠኛ ኮሚቴ ጉዳዩን በጥልቀት በመመርመር ተገቢውን ህጋዊ እርምጃ ይወስዳል።",
      cta: "ጥቆማ ያቅርቡ",
    ...
    howItWorks: {
      ...
      step1title: "ጥቆማዎን ያቅርቡ",
      step1desc:
        "ስለ ጉዳዩ ዝርዝር ያቅርቡ። ስምዎን ሳይጠቀሙ ወይም ከስምዎ ጋር ማቅረብ ይችላሉ።",
      step2title: "ኮሚቴ ይገምግማል",
      step2desc:
        "ኮሚቴያችን ጥቆማዎን ይፈትሻል፣ ማስረጃ ይሰበስባል እና ኦፊሴላዊ ምርምር ይጀምራል።",
    ...
    testimonials: {
      ...
      list: [
        ...
        },
        {
          ...
          role: "ነዋሪ፣ ወረዳ 05",
          content:
            "ስለ ፍትሃዊ ያልሆነ አገልግሎት አሰጣጥ ጥቆማዬን ካቀረብኩ በኋላ፣ ኮሚቴው በጥቂት ቀናት ውስጥ ክትትል አድርጓል። ድምጼ በማህበረሰባችን ውስጥ ለውጥ ማምጣቱ አስገርሞኛል።",
        },
        {
          name: "ዳዊት በቀለ",
          role: "የማህበረሰብ መሪ",
        ...
        },
        {
          ...
          role: "መምህርት",
          content:
            "ቅጹ ቀጥተኛ እና ለመጠቀም ቀላል ነበር። ስለ አንድ አገልግሎት ችግር ጥቆማዬን አቀረብኩ እና ወዲያውኑ ማረጋገጫ አገኘሁ። በሂደቱ ሁሉ እንደተሰማሁ እና እንደተከበርኩ ተሰማኝ።",
        },
        {
          name: "ሄኖክ ተስፋዬ",
          role: "የወጣቶች ተወካይ",
          content:
            "እንደ ወጣት፣ ጥቆማዬ ምንም ለውጥ አያመጣም ብዬ አስቤ ነበር። ይህ ኮሚቴ ስህተት መሆኔን አረጋግጦልኛል። ሪፖርቴን በቁም ነገር ወስደው ችግሩን በሚገባ መርምረዋል።",
        },
        {
          name: "ሰላማዊት አለሙ",
          role: "የጤና ባለሙያ",
    ...
    footer: {
      ...
      readySubtext:
        "ጥቆማዎ ማህበረሰቡ የሚፈልገው ለውጥ ሊሆን ይችላል። ዛሬ በደህና እና በሚስጥር ያቅርቡ።",
      cta: "ጥቆማ ያቅርቡ",
    ...
    form: {
      ...
      // New Fields
      woreda: "ወረዳ",
      woredaPlaceholder: "ለምሳሌ፡ 05",
      subcity: "ክፍለ ከተማ",
      subcityPlaceholder: "ለምሳሌ፡ የካ",
      houseNumber: "የቤት ቁጥር",
      houseNumberPlaceholder: "ለምሳሌ፡ 1024 ወይም አዲስ",
      specificPlace: "ልዩ ቦታ",
      specificPlacePlaceholder: "ለምሳሌ፡ ከወረዳው ጽ/ቤት አጠገብ",
      gender: "ጾታ",
      genderPlaceholder: "ጾታ ይምረጡ...",
      genderMale: "ወንድ",
      genderFemale: "ሴት",
      genderPreferNotToSay: "ባለመናገር መምረጥ",
      age: "ዕድሜ",
      agePlaceholder: "ለምሳሌ፡ 28",
      educationLevel: "የአካዳሚክ ደረጃ / የትምህርት ደረጃ",
      educationLevelPlaceholder: "የትምህርት ደረጃ ይምረጡ...",
      educationUneducated: "ያልተማረ/ች",
      educationGrade4: "እስከ 4ኛ ክፍል",
      educationGrade8: "እስከ 8ኛ ክፍል",
      educationGrade10: "እስከ 10ኛ ክፍል",
      educationGrade12: "እስከ 12ኛ ክፍል (ዲፕሎማ)",
      educationDegree: "ዲግሪና ከዚያ በላይ",
      educationPreferNotToSay: "ባለመናገር መምረጥ",
      incidentLocation: "ድርጊቱ የተፈጸመበት ቦታ (ክፍለ ከተማ / ወረዳ)",
      incidentLocationPlaceholder: "ለምሳሌ፡ የካ ክፍለ ከተማ፣ ወረዳ 05",
      suspectName: "የተጠርጣሪው/የሪፖርት የተደረገው ሰው ስም",
      suspectNamePlaceholder: "ለምሳሌ፡ የኃላፊው ወይም የሰራተኛው ስም",
      // Success
      successTitle: "ጥቆማ ቀርቧል!",
      successText:
        "ጥቆማዎ ደርሷል እና በደህና ተመዝግቧል። ኮሚቴያችን ወዲያውኑ ይገምግመዋል።",
      refLabel: "የማጣቀሻ ቁጥርዎ",
      refSubLabel: "ጥቆማዎን ለመከታተል ይቆጥቡ",
      anonSuccess:
